...
--
-- Name: number_guess number_guess_usernames_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.number_guess
    ADD CONSTRAINT number_guess_usernames_key UNIQUE (username);
